...
def on_connect(client,userdata,flags,rc,properties):
    try:
        ...
        client.subscribe(broker_config.publisher_topic_name_1)
...
def on_message(client,userdata,msg):
    try:
        ...
        # print(data_in_json_format["location"])
        ...
        '''
                ...
                "humidity":random.randint(broker_config.valid_humid_sensor_interval[0], broker_config.valid_humid_sensor_interval[1]),
        ...
        print(humidity_data)
        moisture_data=data_in_json_format['moisture']
        print(moisture_data)
        ...
        cursor = conn.cursor()
        val = (temperature_data,humidity_data,moisture_data,epoch_time)


        
        cursor.execute("INSERT INTO sensor_value(temperature,humidity,moisture_bed_1,epoch_time) VALUES(%s,%s,%s,%s);",val)
        # cursor.execute("INSERT INTO sensor_value_2(moisture_bed_2,epoch_time) VALUES(%s,%s);",moisture_data2)
        conn.commit()
